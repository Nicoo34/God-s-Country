...
AddEventHandler('TREASURE:create', function(x,y,z)
	TriggerEvent('FRP:NOTIFY:Simple', 'Il y a un trésor perdu sur la carte, cherchez la tache rouge.', 10000)
	blip = Citizen.InvokeNative(0x45F13B7E0A15C880, 693035517, x, y, z, 150.0)	
	Citizen.InvokeNative(0x9CB1A1623062F402, blip, 'Trésor perdu')		
end)
