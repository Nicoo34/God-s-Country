        ...
        if my_ilegal_org_id then
            ...
            if outpost_id then
                ...
                if outpost_id == rqst_outpost_id then
                    ...
                    User:notify("error", "Vous n'avez pas accès à ce post")
                end
            else
                User:notify("error", "Votre organisation ne possède aucune publication.")
            end
        else
            User:notify("error", "Vous n'êtes pas dans une organisation illégale")
        end
    end
)
