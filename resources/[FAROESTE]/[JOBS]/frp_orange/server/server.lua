    ...
    function()
     ...
     while HaveOrange do
        ...
        if Inventory:getItemAmount("orange") >= 3 then
            ...
            Inventory:addItem("orange_clean", amountraw)
            orange = true
            ...
            Citizen.Wait(20000)
            User:notify("item", "orange_clean", amountraw)
        else 
...
AddEventHandler(
    ...
    function()
     ...
     while HaveOrangeClean do
        ...
        if Inventory:getItemAmount("orange_clean") >= 10 then
            Inventory:removeItem(-1, "orange_clean", -10)
