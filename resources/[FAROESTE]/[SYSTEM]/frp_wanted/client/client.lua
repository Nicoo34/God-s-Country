...
AddEventHandler(
    ...
    function(targetCoords)
        ...
        Citizen.InvokeNative(0x9CB1A1623062F402, blip, "Coup de feu")
        Wait(8000)
        RemoveBlip(blip)
        -- end
    end
...
AddEventHandler(
    ...
    function(targetCoords)
        local blip = Citizen.InvokeNative(0x45F13B7E0A15C880, 408396114, targetCoords.x, targetCoords.y, targetCoords.z, 60.0)
        Citizen.InvokeNative(0x9CB1A1623062F402, blip, "Temoin")
        Wait(8000)
        RemoveBlip(blip)
    end
)
    ...
    function()
        while true do
            ...
            if annon then
                ...
                DrawTxt("~e~RECHERCHÉ", 0.50, 0.05, 0.9, 0.9, true, 255, 255, 255, 255, true)
                DrawTxt("Capturer ~e~" .. pname .. " ~q~mort ou vif, récompense $" .. reward2, 0.50, 0.10, 0.3, 0.3, true, 255, 255, 255, 255, true)
                DrawTxt("Et apportez-le au shérif de ~e~" .. CityName, 0.50, 0.12, 0.3, 0.3, true, 255, 255, 255, 255, true)
            end
        end
    end
)
