...
AddEventHandler(
	"FRP:ADMIN:Dual",
	function()
		local var1 = GetHashKey('WEAPON_REVOLVER_CATTLEMAN')
		local var2 = GetHashKey('WEAPON_REVOLVER_SCHOFIELD_GOLDEN')
		
		Citizen.InvokeNative(0xB282DC6EBD803C75, PlayerPedId(), var2, 1, true, 0);
		Citizen.InvokeNative(0x5E3BDDBCB83F3D84,PlayerPedId(), var1, 1, true, 0, true, 1.0)
	end
)
