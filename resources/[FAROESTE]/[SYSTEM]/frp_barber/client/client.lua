...
AddEventHandler(
    ...
    function()
        ...
        -- SetEveryoneAsInvisible()        
            ...
            TriggerEvent('FRP:NOTIFY:Simple', 'tu ne peux pas changer de vêtements. ', 10000)
        end
    end
)
...
function createCamera()
 ...
 --  SetCamFov(groundCam, 100)
    ...
    Wait(3000)
    cAPI.OutFade(500)
    TriggerEvent("FRP:NOTIFY:Simple", "Utilisez les touches A et D pour faire pivoter le personnage et les touches fléchées du clavier ou la souris pour créer votre personnage.", 10000)
        ...
        while true do
            ...
            for _, shopPosition in pairs(shops) do
                if #(pPosition - shopPosition) <= 1.5 then
                    ...
                    DrawTxt("Appuyez sur ALT pour ouvrir le magasin de vêtements.", 0.85, 0.95, 0.35, 0.35, true, 255, 255, 255, 200, true, 10000)
