...
function CreatePrompts()
    ...
    prompt_patdown = newPrompt(0x5966D52A, "Fouiller", true, 0)

    prompt_dead_pickup = newPrompt(0xEB2AC491, "Prendre", true, 0)

    prompt_admin_revive = newPrompt(0x7F8D09B8, "Réapparaitre", true, 5)

    prompt_trooper_cuff = newPrompt(0xEB2AC491, "Menotté", true, 1)

    prompt_trooper_uncuff = newPrompt(0x7F8D09B8, "détacher", true, 1)
end
