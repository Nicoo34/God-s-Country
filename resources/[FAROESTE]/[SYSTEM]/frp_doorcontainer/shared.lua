    ...
    function()
            ...
            AddEventHandler(
                ...
                function(doorHash)
                    ...
                    if not doorStates[doorHash] then
                        User:notify("error", "ERREUR DE PORTE ENREGISTRÉ???")
                        return
                    end
                    ...
                    if Character == nil or not Character:hasGroupOrInheritance(doorGroup) then
                        User:notify("error", "tu ne peux pas ouvrir cette porte")
                        return
                    end
                    ...
                    if doorStates[doorHash].pair ~= nil then
                        ...
                        print("Porta " .. doorHash .. " avec paire, mais la paire n'a pas été définie ...")
        ...
        elseif CLIENT then
                        ...
                        if closestDoorHash ~= nil then
                            ...
                            if dist <= 1.7 then
                                ...
                                if HasEntityClearLosToEntityInFront(ped, doorEntity, 0) and not playingUnlockAnimation then
                                    if isOpen == true then
                                        PromptSetActiveGroupThisFrame(prompt_group_close, CreateVarString(10, "LITERAL_STRING", "Porte"))
                                        ...
                                        if closestDoor_displayasclosed == false then
                                            PromptSetActiveGroupThisFrame(prompt_group_open, CreateVarString(10, "LITERAL_STRING", "Porte"))
                                            ...
                                            if hourOpenAt then
                                                PromptSetActiveGroupThisFrame(prompt_group_open, CreateVarString(10, "LITERAL_STRING", "Fermé, Ouvre à " .. hourOpenAt))
                                            else
                                                PromptSetActiveGroupThisFrame(prompt_group_open, CreateVarString(10, "LITERAL_STRING", "Fermé"))
                                            end
            ...
            function initPrompts()
                ...
                PromptSetText(prompt_open, CreateVarString(10, "LITERAL_STRING", "Ouvrir"))
                PromptSetEnabled(prompt_open, true)
                ...
                PromptSetText(prompt_close, CreateVarString(10, "LITERAL_STRING", "Fermer"))
                PromptSetEnabled(prompt_close, true)
