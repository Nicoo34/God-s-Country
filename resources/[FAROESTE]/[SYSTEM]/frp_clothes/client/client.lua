...
function createCamera()
    ...
    Wait(3000)
    cAPI.OutFade(500)
    TriggerEvent("FRP:NOTIFY:Simple", "Utilisez les touches A et D pour faire pivoter le personnage et les touches fléchées du clavier..", 10000)
        ...
        while true do
            ...
            for _, shopPosition in pairs(shops) do
                if #(pPosition - shopPosition) <= 1.5 then
                    ...
                    DrawTxt("Appuyer sur E pour changer de vêtements.", 0.85, 0.95, 0.35, 0.35, true, 255, 255, 255, 200, true, 10000)
