...
function WhistleHorse(whistleTypeHash)
    ...
    if cAPI.IsPlayerHorseActive() and not cAPI.IsPlayerHorseActivationBlocked() then
        ...
        if not cAPI.IsPlayerHorseActivationBlocked() and cAPI.IsPlayerInitialized() then
            ...
            cAPI.notify("error", "Votre cheval est blessé, attendez 2 minutes.")
        end
    end
end
...
function CreatePrompts(prompt_group)
    ...
    PromptSetText(prompt_inventory, CreateVarString(10, "LITERAL_STRING", "Sacoches"))
    ...
    PromptSetText(prompt_eat, CreateVarString(10, "LITERAL_STRING", "Renvoyer"))
    ...
    PromptSetText(prompt_drink, CreateVarString(10, "LITERAL_STRING", "Abreuvé"))
    ...
    PromptSetText(prompt_brush, CreateVarString(10, "LITERAL_STRING", "Brosser"))
