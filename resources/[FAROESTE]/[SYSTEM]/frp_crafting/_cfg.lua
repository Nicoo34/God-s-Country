Config = {
    ...
    {
        --position = vec3(2859.25, -1267.30, 46.72), -- No position, its global
          alhambic = true,
           craftings = {
            {
                time = 60,
            ...
            },
            {
                ...
                input ={
                    ...
                    {item = "corn", amount = 1},
                    {item = "sugar", amount = 1},
                    {item = "herb_black_current", amount = 1}
                },
                output = {
                    {item = "moonshine_cassis", amount =1}
                }
            },
            {
                time = 60,
                input ={
                    ...
                    {item = "corn", amount = 1},
                    {item = "sugar", amount = 1},
                    {item = "potassio", amount = 1}
                },
                output = {
                    {item = "moonshine_potassium", amount =1}
                }
            },
        }
    }
