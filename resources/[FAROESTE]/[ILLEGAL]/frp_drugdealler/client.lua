		...
		if not servico then
			...
			if distance <= 30.0 and not StartDrugs then
				...
				if distance <= 1.2 then
					DrawText("APPUYER SUR  ~b~ALT~w~  POUR OBTENIR LES ITINÉRAIRES" , 0.925, 0.96, 0.25, 0.25, false, 255, 255, 255, 145, 1, 7)
	...
	while true do
		...
		if servico then
			...
			if distance <= 30.0 then
				...
				if distance <= 1.2 then
					DrawText("APPUYER SUR  ~b~E~w~  POUR LIVRER" , 0.925, 0.96, 0.25, 0.25, false, 255, 255, 255, 145, 1, 7)
					if IsControlJustPressed(0, 0xE8342FF2) then
