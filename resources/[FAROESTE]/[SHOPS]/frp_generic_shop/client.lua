        ...
        if shop_type == "buy" then
            if tonumber(transaction_dollar) or transaction_gold then
                if transaction_gold then
                    ...
                    PromptSetText(prompt_transaction, CreateVarString(10, "LITERAL_STRING", "Acheter"))
                end
            else
                PromptSetText(prompt_transaction, CreateVarString(10, "LITERAL_STRING", "Prendre"))

                PromptSetVisible(prompt_transaction_extra, false)
            end
        elseif shop_type == "sell" then
            PromptSetText(prompt_transaction, CreateVarString(10, "LITERAL_STRING", "Vendre"))
