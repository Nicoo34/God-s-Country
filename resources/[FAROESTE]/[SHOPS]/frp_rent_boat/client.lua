...
Citizen.CreateThread(function()
 WarMenu.CreateMenu('ShopBoat', 'Location de bateaux')
 WarMenu.SetSubTitle('ShopBoat', 'Liste des bateaux')
	while true do
		Citizen.Wait(0)
		...
		if WarMenu.IsMenuOpened('ShopBoat') then
				...
				if WarMenu.Button('Canoe 15$') then
				TriggerServerEvent('bberry:buyvehicle', 15, 'canoe')
				elseif WarMenu.Button('Bateau 2 Personnes 20$') then
...
Citizen.CreateThread(function()
	WarMenu.CreateMenu('ShopBoat', 'Bateau de police')
	WarMenu.SetSubTitle('ShopBoat', 'Liste des bateaux')
