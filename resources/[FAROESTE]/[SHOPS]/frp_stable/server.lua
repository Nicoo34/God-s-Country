...
AddEventHandler(
    ...
    function(id)
        ...
        if Horse == nil then            
            TriggerClientEvent('FRP:NOTIFY:Simple', _source, 'tu as déjà vendu ce cheval.', 5000)
            return
        end

        TriggerClientEvent('FRP:NOTIFY:Simple', _source, 'Cheval vendu avec succès.', 5000)  
